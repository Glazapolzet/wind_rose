...
class Ui_ROSA_VETROV(object):
    ...
    def setupUi(self, ROSA_VETROV):
        ...
        # setting minimum and maximum n_date
        self.n_data.setMinimumDate(QtCore.QDate(2006, 9, 1))
        self.n_data.setMaximumDate(QtCore.QDate(2024, 9, 1))
        self.n_data.setToolTip('Начальная дата для расчета (не более 31.07.2024)')
        ...
        self.k_data.setToolTip('Конечная дата для расчета (не более 31.08.2025)')
        ...
        # Для поля условий расчета
        self.r_cond.setStyleSheet("""
                background-color: rgb(255, 255, 255);
                color: rgb(0, 0, 0);
            """)

        # Для названия розы ветров
...
#        self.meteostation.setItemText(3, _translate("ROSA_VETROV", "Все для сравнения"))
    ...
    def equal(self):
        print("self")
        dict = {'Мценск': 'archiv_mcensk_05_24.csv','Орел': 'arсhiv_orel_05_24.csv','Верховье': 'arсhiv_verh_05_21.csv'}
#
#           ,'Верховье': 'archiv_verh_05_25.csv','Орел': 'archiv_orel_05_23.csv'}
        ...
        if self.n_data.date().toString('yyyy.MM.dd') > self.k_data.date().toString('yyyy.MM.dd'):
            ...
            print(dict[ui.meteostation.currentText()])
            print("___")
